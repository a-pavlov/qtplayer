...
class VlcQmlPlayer : public VlcQmlSource
{
    ...
    /*!
        \brief Current media length in ms
        \see length
        \see lengthChanged
     */
    ...
    Q_PROPERTY(QString urlFile READ urlFile WRITE setUrlFile NOTIFY urlFileChanged)
...
public:
    ...
    void setUrlFile(const QString& file);
